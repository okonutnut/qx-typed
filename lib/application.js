...
class TableWidget extends qx.ui.container.Composite {
    constructor(columns, options) {
        ...
        this.__filterInputs = new Map();
        this.__currentPage = 1;
        this.__pageSize = 10;
        this.__totalPages = 1;
        this.__columns = columns;
        this.__options = options !== null && options !== void 0 ? options : {};
        this.__pageSize = (_a = this.__options.pageSize) !== null && _a !== void 0 ? _a : 10;
    ...
    __buildToolbar() {
        ...
        const filterBtn = new BsButton("Filters", new InlineSvgIcon("filter", 16), { size: "sm", variant: "outline" });
    ...
    __buildOffcanvas() {
        ...
        const closeBtn = new BsButton("", new InlineSvgIcon("x", 18), { size: "sm", variant: "ghost" });
        ...
        const clearBtn = new BsButton("Clear All", new InlineSvgIcon("x-circle", 16), { size: "sm", variant: "outline" });
        clearBtn.onClick(() => {
            this.__searchInput.setValue("");
        ...
        const applyBtn = new BsButton("Apply", new InlineSvgIcon("check", 16), { size: "sm", variant: "default" });
    ...
    `;
        ...
        const elem = this.__tableContainer.getContentElement().getDomElement();
        if (elem) {
            this.__tableBody = elem.querySelector(".table-body");
        }
    ...
    __buildPagination() {
        ...
        const prevBtn = new BsButton("Prev", new InlineSvgIcon("chevron-left", 14), { size: "sm", variant: "outline" });
        ...
        const nextBtn = new BsButton("Next", new InlineSvgIcon("chevron-right", 14), { size: "sm", variant: "outline" });
    ...
    __goToPage(page) {
        if (page < 1 || page > this.__totalPages)
            return;
    ...
    __applyFilters() {
        var _a, _b;
        const searchTerm = (_b = (_a = this.__searchInput.getValue()) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : "";
        const columnFilters = new Map();
        this.__filterInputs.forEach((input, colIdx) => {
            var _a, _b;
            const value = (_b = (_a = input.getValue()) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : "";
            if (value) {
    ...
    __updateTable() {
        ...
        const totalLabel = children[children.length - 1];
...
class BsOffcanvas extends qx.ui.container.Composite {
    constructor(content, placement = "end") {
        super(new qx.ui.layout.Canvas());
        this.__open = false;
        this.__isAnimating = false;
        this.__animationToken = 0;
    ...
    __initStyles() {
        const el = this.__panel.getContentElement().getDomElement();
        if (!el) {
    ...
    __hideImmediate() {
        var _a;
        const el = (_a = this.__panel.getContentElement()) === null || _a === void 0 ? void 0 : _a.getDomElement();
    ...
    open() {
        ...
        this.__isAnimating = true;
        const token = ++this.__animationToken;
        let backdrop = document.body.querySelector(".offcanvas-backdrop");
        if (!backdrop) {
        ...
        requestAnimationFrame(() => {
            backdrop === null || backdrop === void 0 ? void 0 : backdrop.classList.add("show");
        });
        qx.event.Timer.once(() => {
            if (token !== this.__animationToken)
                return;
