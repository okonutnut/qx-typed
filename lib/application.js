...
class FacultyPage extends qx.ui.container.Composite {
    constructor() {
        ...
        if (isAdmin()) {
            const addBtn = new BsButton("Add New", new InlineSvgIcon("plus", 16), { size: "sm", variant: "default" });
...
class RoomsPage extends qx.ui.container.Composite {
    constructor() {
        ...
        const toolbar = new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
        if (isAdmin()) {
            const addBtn = new BsButton("Add Room", new InlineSvgIcon("plus", 16), { size: "sm", variant: "default" });
            addBtn.onClick(() => this.__showFormDialog());
            toolbar.add(addBtn);
        }
        const refreshBtn = new BsButton("Refresh", new InlineSvgIcon("refresh-cw", 16), { size: "sm", variant: "outline" });
...
class SchedulesPage extends qx.ui.container.Composite {
    constructor() {
        ...
        if (isAdmin()) {
            const addBtn = new BsButton("Add Schedule", new InlineSvgIcon("plus", 16), { size: "sm", variant: "default" });
            addBtn.onClick(() => this.__showFormDialog());
            toolbar.add(addBtn);
        }
        const refreshBtn = new BsButton("Refresh", new InlineSvgIcon("refresh-cw", 16), { size: "sm", variant: "outline" });
...
class SemestersPage extends qx.ui.container.Composite {
    constructor() {
        ...
        const toolbar = new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
        if (isAdmin()) {
            const addBtn = new BsButton("Add Semester", new InlineSvgIcon("plus", 16), { size: "sm", variant: "default" });
            addBtn.onClick(() => this.__showFormDialog());
            toolbar.add(addBtn);
        }
        const refreshBtn = new BsButton("Refresh", new InlineSvgIcon("refresh-cw", 16), { size: "sm", variant: "outline" });
