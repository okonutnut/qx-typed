...
class Navbar extends qx.ui.container.Composite {
    constructor(pageTitle, onToggleSidebar) {
        ...
        // NOTIFICATION BELL
        this.__notifyBtn = new BsButton("", new InlineSvgIcon("bell-off", 16), { size: "icon", variant: "ghost", className: "btn-sm p-1" });
...
class AgGridTable extends qx.ui.container.Composite {
    constructor(columns, options) {
        ...
        const model = this.__tableModel;
        model.setColumns(this.__columns.map((c) => c.headerName), this.__columns.map((c) => { var _a; return (_a = c.field) !== null && _a !== void 0 ? _a : ""; }));
        ...
        const columnModel = this.__table.getTableColumnModel();
