...
class FacultyPage extends qx.ui.container.Composite {
    ...
    __assignSubjects() {
        ...
        Promise.all([
            ...
            currentLabel.setFont(new qx.bom.Font(12).set({ bold: true }));
            ...
            if (unassigned.length > 0) {
                ...
                addLabel.setFont(new qx.bom.Font(12).set({ bold: true }));
...
class SubjectsPage extends qx.ui.container.Composite {
    constructor() {
        ...
        const toolbar = new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
        if (isAdmin()) {
            const addBtn = new BsButton("Add New", new InlineSvgIcon("plus", 16), "btn-sm", "primary");
            addBtn.onClick(() => this.__showFormDialog());
            toolbar.add(addBtn);
        }
        const refreshBtn = new BsButton("Refresh", new InlineSvgIcon("refresh-cw", 16), "btn-sm-outline");
        ...
        if (isAdmin()) {
            const actionBar = new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
            const editBtn = new BsButton("Edit", undefined, "btn-sm-outline", "outline");
            editBtn.setWidth(120);
            editBtn.onClick(() => this.__editSelected());
            const deleteBtn = new BsButton("Delete", undefined, "btn-sm-destructive", "destructive");
