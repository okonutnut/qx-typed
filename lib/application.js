...
class ButtonsPage extends qx.ui.container.Composite {
    constructor() {
        ...
        const button1 = new BsButton("Hello", new InlineSvgIcon("message-circle", 16), "btn-primary btn-sm w-full");
        const button2 = new BsButton("Dark Theme", new InlineSvgIcon("moon", 16), "btn-secondary btn-sm w-full");
        const button3 = new BsButton("Light Theme", new InlineSvgIcon("sun", 16), "btn-accent btn-sm w-full");
        const button4 = new BsButton("Change Layout", new InlineSvgIcon("layout-panel-top", 16), "btn-outline btn-sm w-full");
        button1.onClick(() => {
            alert("Hello World!");
        });
        button2.onClick(() => {
        ...
        button4.onClick(() => {
            ...
            container.setLayout(isRowLayout ? new qx.ui.layout.HBox(8) : new qx.ui.layout.VBox(8));
        });
