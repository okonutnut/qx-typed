...
class Navbar extends qx.ui.container.Composite {
    constructor(pageTitle, onToggleSidebar) {
        ...
        actionsMenu.add(this.__createActionsMenuButton("About", new InlineSvgIcon("info", 16), "about"));
...
class BsSidebarAccount extends qx.ui.basic.Atom {
    ...
    __buildMenuWidgets() {
        ...
        this.__menuContainer.add(this.__createMenuButton("Log out", new InlineSvgIcon("log-out", 16), "⇧⌘Q"));
    }
